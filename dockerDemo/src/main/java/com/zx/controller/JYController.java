...
public class JYController {
    ...
    @PostMapping("/delete")
    public void delete() throws UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        String aaa="jsapi_ticket=HoagFKDcsGMVCIY2vOjf9jkmZ1KQu8HqhbCijGmc0Li6RCKbimf8Cbb-oo-xERKy6oY6ztIDCC7QoeNFu2JM9w&noncestr=pjjfkZf2ORcc4AUD&timestamp=1673613036&url=https://qiwei.guokang.com/workKanban/service/importMedicalRecord.htm?id=854112&memberCode=11402950&objId=1074703";
        System.out.println(getSha1(aaa));
