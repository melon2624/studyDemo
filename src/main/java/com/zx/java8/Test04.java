...
public class Test04 {
    ...
    public static void main(String[] args) {
        ...
        arrayList.add(new UserEntity("zx",24));
   ...
   //    ------------------------------------------------------
        UserEntity user1=new UserEntity("zx",24);
        UserEntity user2=new UserEntity("zx",26);
...
//----------------------------------------------------------------------------------------
    ...
    boolean b=    list.stream().anyMatch(new Predicate<UserEntity>() {
            ...
            public boolean test(UserEntity userEntity) {
                return userEntity.getUserName().equals("zx");
            }
        });
    boolean b2=list.stream().anyMatch(userEntity -> userEntity.getUserName().equals("zx"));
...
//--------------------------------------------------------------------------------------
        ...
        list.stream().filter(new Predicate<UserEntity>() {
            ...
            public boolean test(UserEntity userEntity) {
                ...
                return userEntity.getUserName().equals("zx")&&userEntity.getAge()>25;
            }
